...
qm create $VMID --name $VM_NAME --memory $MEMORY --sockets $CPU_SOCKETS --cores $CPU_CORES --cpu host --bios seabios --ostype l26 --scsihw virtio-scsi-pci --net0 virtio,bridge=vmbr0
