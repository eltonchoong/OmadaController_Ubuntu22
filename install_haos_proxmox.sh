...
# ================================================================
# Home Assistant OS auto-install script for Proxmox VE (safe version)
...
cleanup() {
    ...
    rm -f /tmp/haos_ova-15.2.qcow2 /tmp/haos_ova-15.2.raw
    exit 1
}
...
echo "✅ Home Assistant OS VM $VMID created successfully!"
