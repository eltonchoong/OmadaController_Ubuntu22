...
qm create $VMID --name $VM_NAME --memory $MEMORY --sockets $CPU_SOCKETS --cores $CPU_CORES --cpu host --bios ovmf --efidisk0 local-lvm:0,efitype=4m,format=raw --ostype l26 --scsihw virtio-scsi-pci --net0 virtio,bridge=vmbr0
