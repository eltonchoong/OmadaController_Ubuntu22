...
#   - Attach system disk
#   - Configure boot order explicitly
...
echo "⚙️ Explicitly setting boot order to scsi0..."
qm set $VMID --boot order=scsi0

echo "✅ Confirming boot order in VM config:"
qm config $VMID | grep boot

echo "🧹 Cleaning up temporary files..."
rm -f /tmp/haos_ova-15.2.qcow2 /tmp/haos_ova-15.2.raw /tmp/haos_ova-15.2.qcow2.xz

echo "✅ Home Assistant OS VM $VMID created successfully with EFI disk and correct boot order!"
